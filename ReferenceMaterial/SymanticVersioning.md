...
6. Patch version Z (x.y.Z | x > 0) MUST be incremented if only backwards compatible bug fixes are introduced. A bug fix is defined as an internal change that fixes incorrect behaviour.
...
---
#### About
reproduced from freely available material at [semver.org](https://semver.org/) for use as personal reference material. The Semantic Versioning specification was originally authored by [Tom Preston-Werner](https://tom.preston-werner.com/), inventor of Gravatar and co-founder of GitHub and is licenced under [Creative Commons ― CC BY 3.0](https://creativecommons.org/licenses/by/3.0/).